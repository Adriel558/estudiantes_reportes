...
public class ViewReports extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("MENU DE GENERACION DE REPORTES");

        jPanel1.setBorder(javax.swing.BorderFactory.createTitledBorder("Reporte por estado"));
        ...
        jPanel2.setBorder(javax.swing.BorderFactory.createTitledBorder("Reporte por estudiante"));
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        if (jComboBox1.getSelectedItem() == null) {
            JOptionPane.showMessageDialog(this, "jComboBox1 no debe estar vacío", "Error", JOptionPane.ERROR_MESSAGE);
        } else {
            String selectedItem = (String) jComboBox1.getSelectedItem();
            //JOptionPane.showMessageDialog(this, "Elemento seleccionado: " + selectedItem);
            Report1 ventana = new Report1(selectedItem);
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        if (jTextField1.getText().isEmpty()) {
            JOptionPane.showMessageDialog(this, "jTextField1 no debe estar vacío", "Error", JOptionPane.ERROR_MESSAGE);
        } else {
            String textFieldValue = jTextField1.getText();
            //JOptionPane.showMessageDialog(this, "Texto ingresado: " + textFieldValue);
            Report2 ventana = new Report2(textFieldValue);
            ventana.setVisible(true);
            this.setVisible(false);
