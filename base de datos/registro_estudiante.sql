...
--
-- Host: localhost    Database: registro_estudiantes
-- ------------------------------------------------------
...
INSERT INTO `documentos` VALUES (1,'INE','1001'),(2,'Pasaporte','1002'),(3,'Licencia de conducir','1003'),(4,'Cédula profesional','1004');
...
CREATE TABLE `estudiantes` (
  ...
  CONSTRAINT `estudiantes_ibfk_1` FOREIGN KEY (`estado_id`) REFERENCES `estados` (`id`),
  CONSTRAINT `estudiantes_ibfk_2` FOREIGN KEY (`estado_civil_id`) REFERENCES `estado_civil` (`id`),
  CONSTRAINT `estudiantes_ibfk_3` FOREIGN KEY (`documento_id`) REFERENCES `documentos` (`id`)
...
INSERT INTO `usuarios` VALUES (1,'user1','admin');
...
-- Dump completed on 2024-07-21 12:55:32
